...
data:
  ...
  # Milvus (Sin cambios)
  QUERY_MILVUS_URI: "http://milvus.nyro-develop.svc.cluster.local:19530" # Asumiendo que Milvus está en el mismo namespace
  ...
  # --- NUEVA CONFIGURACIÓN ---
  QUERY_EMBEDDING_SERVICE_URL: "http://embedding-service.nyro-develop.svc.cluster.local:8003" # URL del servicio de embedding
...
data:
  ...
  QUERY_RERANKER_ENABLED: "true"
  QUERY_RERANKER_SERVICE_URL: "http://reranker-service.nyro-develop.svc.cluster.local:80"
...
metadata:
  ...
  namespace: nyro-develop # Asegúrate que el namespace sea el correcto
  labels:
...
data:
  ...
  # Reranker Service (Remote)
  QUERY_RERANKER_ENABLED: "true"
  QUERY_RERANKER_SERVICE_URL: "http://reranker-gpu.nyro-develop.svc.cluster.local" # "http://reranker-service.nyro-develop.svc.cluster.local:80" normal
  QUERY_RERANKER_CLIENT_TIMEOUT: "220"
...
data:
  ...
  # Reranker Service (Remote)
  QUERY_RERANKER_ENABLED: "true"
  QUERY_RERANKER_SERVICE_URL: "http://reranker-gpu-service.nyro-develop.svc.cluster.local:8004/" # "http://reranker-service.nyro-develop.svc.cluster.local:80" normal
  QUERY_RERANKER_CLIENT_TIMEOUT: "220"
